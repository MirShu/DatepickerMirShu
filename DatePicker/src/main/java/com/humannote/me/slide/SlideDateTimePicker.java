...
public class SlideDateTimePicker {
    ...
    private boolean mOnlyDate = true;
    private boolean mOnlyTime = false;
    ...
    public void show() {
        ...
        SlideDateTimeDialogFragment dialogFragment =
                SlideDateTimeDialogFragment.newInstance(
                        ...
                        mIs24HourTime,
                        mTheme,
                        mIndicatorColor, mOnlyDate, mOnlyTime);
    ...
    public static class Builder {
        ...
        public SlideDateTimePicker build() {
            ...
            picker.setOnlyDate(onlyDate);
            picker.setOnlyTime(onlyTime);
            return picker;
        }
    }
}
