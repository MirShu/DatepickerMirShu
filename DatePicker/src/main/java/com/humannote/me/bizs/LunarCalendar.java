...
public class LunarCalendar {
     ...
     *
     */
    final static String chineseDay[] = {"一", "二", "三", "四", "五", "六", "七", "八", "九", "十"};
    ...
    public String toString() {
        //农历壬辰(龙)年八月廿二
        String str = MessageFormat.format("农历{0}（{1}）年{2}月{3}", cyclical(), animalsYear(), chineseNumber[month - 1], getChinaDayString(day));
        return str;
        //return "农历" + cyclical() + "(" + animalsYear() + ")年" + chineseNumber[month - 1] + "月" + getChinaDayString(day);
     ...
     * @return
     */
    public String toLunarCalendar() {
        String str = MessageFormat.format("农历{0}月{1}日", chineseNumber[month - 1], getChinaDayString(day));
        return str;
    }
}